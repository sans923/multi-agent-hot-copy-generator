...
def create_tables() -> None:
    ...
    """
    from app.models import user, task, document, copy, agent_log, hotlist_sync, toutiao_reference, orchestration_audit_log, system_log, memory_index_job, memory, knowledge  # noqa: F401
